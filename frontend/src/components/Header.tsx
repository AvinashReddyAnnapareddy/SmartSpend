      ...
      <div className="flex items-center gap-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="relative" ref={dropdownRef}>
            ...
            >
              <div className="w-8 h-8 bg-brand-600 rounded-lg flex items-center justify-center font-bold text-white text-xs">
                {user ? getAvatar(user.username) : '?'}
              </div>
              <div className="text-left hidden sm:block">
                <p className="text-xs font-bold text-[#1e293b]">{user ? user.username : 'Loading...'}</p>
              </div>
            ...
            {isDropdownOpen && (
              <div className="absolute right-0 mt-2 w-64 bg-white border border-[#e2e8f0] rounded-xl shadow-xl py-2 z-50 animate-in fade-in slide-in-from-top-2 duration-200">
                <div className="px-4 py-2 border-b border-[#e2e8f0] mb-1">
                  <p className="text-xs font-bold text-[#1e293b]">{user?.username}</p>
